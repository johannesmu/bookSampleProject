  ...
  return (
    <div className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container-fluid">
        ...
        <nav className="navbar navbar-nav flex-row mx-2 order-2 order-sm-2 order-md-3">
        ...
        <div className="collapse navbar-collapse order-5 order-sm-5 order-md-5" id="navbarSupportedContent">
